subroutine build_residual(residual,t2,abij_antispinint,u,v)
  BEGIN_DOC
  ! residual
  END_DOC
  ...
  double precision,intent(in),dimension(n_spin_occ,n_spin_occ,n_spin_virt,n_spin_virt) :: u,v
  ...
  do i=1,n_spin_occ
    do j=1,n_spin_occ
      do a=1,n_spin_virt
        do b=1,n_spin_virt
          residual(i,j,a,b) = abij_antispinint(a,b,i,j) + ijab_D(i,j,a,b)*t2(i,j,a,b)+u(i,j,a,b)+v(i,j,a,b)
        end do
      end do
    end do
  end do
